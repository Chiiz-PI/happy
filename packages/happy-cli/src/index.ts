...
`)
    ...
    // Handle grok command (ACP-based agent): `happy grok` is `happy acp grok`
    try {
      ...
      const resolved = resolveAcpAgentConfig(['grok', ...passthroughArgs]);
...
${chalk.bold('Examples:')}
  ...
  happy grok               Start Grok Build via generic ACP runner
