...
interface AgentInputProps {
    ...
    agentType?: 'claude' | 'codex' | 'gemini' | 'grok' | 'openclaw';
    onAgentClick?: () => void;
...
const getContextWarning = (contextSize: number, alwaysShow: boolean = false, theme: Theme, contextWindow?: number | null) => {
    const maxContextSize = contextWindow && contextWindow > 0 ? contextWindow : MAX_CONTEXT_SIZE;
                                ...
                                {props.agentType && props.onAgentClick && (
                                    ...
                                    >
                                        ...
                                        <Text style={{
                                            ...
                                            {props.agentType === 'claude' ? t('agentInput.agent.claude') : props.agentType === 'codex' ? t('agentInput.agent.codex') : props.agentType === 'openclaw' ? t('agentInput.agent.openclaw') : props.agentType === 'grok' ? t('agentInput.agent.grok') : t('agentInput.agent.gemini')}
                                        </Text>
                                    </Pressable>
                                )}
